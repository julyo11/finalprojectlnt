            ...
            <form method="post" action="/items/{{$item->id}}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('Kategori') is-invalid @enderror" id="Kategori"
                        placeholder="Masukkan kategori" name="Kategori" value="{{ $item->Kategori }}">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('Nama') is-invalid @enderror" id="Nama"
                        placeholder="Masukkan nama" name="Nama" value="{{ $item->Nama }}">
                    <div class=" invalid-feedback">
                        @error('Nama')
                        {{$message}}
                        @enderror
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('Harga') is-invalid @enderror" id="Harga"
                        placeholder="Rp." name="Harga" value="{{ $item->Harga }}">
                    <div class="invalid-feedback">
                        @error('Harga')
                        {{$message}}
                        @enderror
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('Jumlah') is-invalid @enderror" id="Jumlah"
                        placeholder="Masukkan jumlah" name="Jumlah" value="{{ $item->Jumlah }}">
                    <div class="invalid-feedback">
                        @error('Jumlah')
                        {{$message}}
                        @enderror
